function ansvalidation(event) {
    ...
    localStorage.setItem("htmltotalscore",mark);//To store the mark variable value in the localstorage through a key value total score
    if(selectedOptionq1==null&&selectedOptionq2==null&&selectedOptionq3==null&&selectedOptionq3==null&&selectedOptionq4==null&&selectedOptionq5==null){
        ...
        Swal.fire({
            ...
            window.location.href="../NotesWarehouse/HTML CSS/D6.html"
        });
    }
    else if(mark<3){
        Swal.fire({
